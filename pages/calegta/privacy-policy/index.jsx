    ...
    <>
      <Layout pageTitle={"Privacy Policy for CalegTa - FreePrivacyPolicy.com"}>
        <Container maxWidth={"6xl"} pb="40px" pt="53px">
          ...
          <Heading mb="20px" as="h1" size="xl" noOfLines={1}>
          ...
          <Text my="16px">For the purposes of this Privacy Policy:</Text>
          <Box pl="40px">
            <ul style={{ lineHeight: 3 }}>
              ...
              <li>
                <p>
                  <strong>Application</strong> refers to CalegTa, the software
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to PT. Aganta
                  Teknologi Solutif, Jl. Dato Ripanggentungang, Paccinongang,
                  Kec. Somba Opu, Kabupaten Gowa, Sulawesi Selatan 92113.
                </p>
              </li>
              <li>
                <p>
          ...
          <Heading mb="20px" as="h1" size="xl" noOfLines={1} mt="20px">
            Collecting and Using Your Personal Data
          </Heading>
          <Heading as="h3" size="lg">
            Types of Data Collected
          </Heading>
          <Heading my="16px" as="h4" size="md">
            Personal Data
          </Heading>
          <Text mb="16px">
          ...
          <Text my="16px">
            Generated using{" "}
            <Link href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/">
              Free Privacy Policy Generator
            </Link>
          </Text>
        </Container>
