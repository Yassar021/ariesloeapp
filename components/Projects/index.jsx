        ...
        <Box pb='90px'>
            ...
            <Container maxW='8xl'>            
                <Box mt='110px' textAlign={{base:'center',md:'center',lg:'center',xl:'center','2xl':'center'}} alignContent='center'>       
                    ...
                    <CardProject image={'/a-project.png'} title={'MIMS Web Dashboard'} desc={'Established in 1963, MIMS is a multi-channel provider of drug information, medical education and services connecting healthcare communities. Our work empowers healthcare professionals to improve patient outcomes by facilitating knowledge exchange and better decision-making. Today, MIMS is present in 12 countries across Asia Pacific with approximately two million healthcare professional subscribers to its drug & resource portal, digital and print publications.'} />
