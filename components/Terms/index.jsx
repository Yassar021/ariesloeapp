        ...
        <Box pb='114px'>
            <Flex  mt='101px' direction={{base:'column',md:'row',lg:'row',xl:'row','2xl':'row'}} justifyContent='center' textAlign={{base:'center',md:'left',lg:'left',xl:'left','2xl':'left'}}>
                <Box my='auto' textAlign={'center'}>
                    <Text fontSize={'16px'} fontWeight={'600'} color='#16FCD2' letterSpacing={'0.1em'}>Terms</Text>
                    <Text mt='13px' fontSize={'36px'} fontWeight='700' color='#fff' lineHeight='54px'>Terms & Conditions</Text>
                    <Text mt='25px' fontSize={'14px'} color='rgba(255, 255, 255, 0.6)'>Updated at 2021-05-06</Text>
                </Box>
            </Flex>
