...
const CardTesti = ({image,name,company,message}) => {
    return( 
        <Box borderRadius='3px' w={{base:'288px',md:'387px',lg:'100%',xl:'100%','xl':'100%'}} h={{base:'500',md:'447px',lg:'556px',xl:'447px','xl':'447px'}} bgColor={'rgba(255, 255, 255, 0.05)'} py='60px' px={'47px'}>
