    ...
    <Box pb="110px" mt="101px">
      <Flex direction={"column"} alignItems="center" textAlign={"center"}>
        ...
        >
          ...
          <br /> as quickly as possible. Even on the same day. Even so, we do
          not
          <br /> reduce the quality of our work.
        </Text>
        <Stack
          direction={{
            base: "column",
        ...
        >
          <Box
            maxW="328px"
            h={{ md: "400px", lg: "276px", xl: "276px", "2xl": "276px" }}
            py="30px"
            px="46px"
          ...
          >
            ...
            <Text
              ...
              color="rgba(255, 255, 255, 0.6)"
            >
              The project interface will be designed first, our favorite tool is
              Figma.
            </Text>
          </Box>
          <Box
          ...
          >
            ...
            <Text
              ...
              color="rgba(255, 255, 255, 0.6)"
            >
              After the work is complete, we will send the project and all its
              assets to you.
            </Text>
          </Box>
        </SimpleGrid>
          ...
          >
            ...
            >
              ...
              <Text
                ...
                lineHeight={"48px"}
              >
                We are a team of designers, engineers and analysts
              </Text>
              <Text
                mt="28px"
                fontSize={"16px"}
              ...
              >
                ...
                committed to maintaining quality work as well as speed. These
                creative <br />
                people work together to create maximum work results.
              </Text>
              <Link
                href="/about"
                alignItems={"left"}
