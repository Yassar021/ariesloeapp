...
export default function Footer() {
    return ( 
        ...
        <Flex direction={{base:'column',md:'row',lg:'row',xl:'row','2xl':'row'}} gap={{base:'40px',md:'0px',}} justifyContent='space-between' mt='105px' alignItems={{base:'center',md:'left',lg:'left',xl:'left','2xl':'left'}} textAlign={{base:'center',md:'left',lg:'left',xl:'left','2xl':'left'}}>
            <Box mb='auto'>
                <Link href='/'>
                    <HStack spacing='12px'>
