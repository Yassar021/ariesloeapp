    ...
    <Box pb="120px">
      ...
      >
        ...
        >
          ...
          >
            <Box
              w={{ base: "100%", md: "auto", lg: "176px", "2xl": "236px" }}
              h={{ md: "220px", lg: "220px", xl: "220px", "2xl": "220px" }}
              pt="20px"
              py="40px"
          ...
          >
            ...
            <Text
              ...
              color="rgba(255, 255, 255, 0.6)"
            >
              We started with a commitment, and our team stands behind our
              promise to deliver timely and quality services, we love to solve
              your problem.
            </Text>
          </Box>
        </Flex>
