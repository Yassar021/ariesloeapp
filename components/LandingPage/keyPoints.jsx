...
export default function KeyPoint() {
    return (
        <Box pb='120px' bgColor='#221048' px={{base:'20px',md:'60px'}} alignItems='center' textAlign={'center'}>
            <Flex direction={'column'}  alignItems='center' textAlign={'center'}>
                ...
                <SimpleGrid columns={{md:1,lg:2,xl:3,'2xl':3}} spacing='40px' mt='70px'>
                    <Box textAlign={{md:'center',lg:'left'}}>
                        <Stack mx={{md:'auto',lg:'0px'}} maxW='60' alignContent={{base:'center',md:'center',lg:'left'}} alignItems={{base:'center',md:'center',lg:'start'}}>
                    ...
                    <Box textAlign={{md:'center',lg:'left'}}>
                        ...
                        <Text my='20px' fontSize={'28px'} fontWeight={'700'} color='#fff' letterSpacing={'0.1em'}>Secure and Safe Coding</Text>
                        <Text my='20px' fontSize={'16px'} fontWeight={'500'} color='rgba(255, 255, 255, 0.6)' letterSpacing={'0.1em'}>Build secure apps with the best code quality. Security is our first goal.</Text>
                    </Box>
                    <Box textAlign={{md:'center',lg:'left'}}>
                        <Stack mx={{md:'auto',lg:'0px'}}  maxW='60'alignContent={{base:'center',md:'center',lg:'left'}} alignItems={{base:'center',md:'center',lg:'start'}}>
                            <svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.1056 3.44721L5.78885 6.10557C5.00831 6.49585 4.61803 6.69098 4.61803 7C4.61803 7.30902 5.00831 7.50415 5.78885 7.89443L11.1056 10.5528C11.5445 10.7722 11.7639 10.882 12 10.882C12.2361 10.882 12.4555 10.7722 12.8944 10.5528L18.2111 7.89443C18.9917 7.50415 19.382 7.30902 19.382 7C19.382 6.69098 18.9917 6.49585 18.2111 6.10557L12.8944 3.44721C12.4555 3.22776 12.2361 3.11803 12 3.11803C11.7639 3.11803 11.5445 3.22776 11.1056 3.44721Z" fill="white"/>
                                <path fillRule="evenodd" clipRule="evenodd" d="M7.02204 10.4893C7.62591 10.8135 8.33704 11.169 9.15542 11.5782L10.2111 12.1061C11.089 12.545 11.5279 12.7644 12 12.7644C12.4721 12.7644 12.911 12.545 13.7889 12.1061L14.8446 11.5782C15.663 11.169 16.3741 10.8135 16.978 10.4893L18.2112 11.1059C18.9917 11.4961 19.382 11.6913 19.382 12.0003C19.382 12.3093 18.9917 12.5044 18.2112 12.8947L12.8944 15.5531C12.4555 15.7725 12.2361 15.8822 12 15.8822C11.7639 15.8822 11.5445 15.7725 11.1056 15.5531L11.1056 15.5531L5.78886 12.8947C5.00832 12.5044 4.61804 12.3093 4.61804 12.0003C4.61804 11.6913 5.00832 11.4961 5.78886 11.1059L7.02204 10.4893Z" fill="white"/>
                                <path fillRule="evenodd" clipRule="evenodd" d="M7.02157 15.4893C7.62555 15.8135 8.33684 16.1692 9.15544 16.5785L10.2112 17.1063C11.089 17.5452 11.5279 17.7647 12 17.7647C12.4722 17.7647 12.9111 17.5452 13.7889 17.1063L14.8446 16.5785C15.6632 16.1692 16.3745 15.8135 16.9785 15.4893L18.2112 16.1056C18.9917 16.4959 19.382 16.691 19.382 17C19.382 17.3091 18.9917 17.5042 18.2112 17.8945L12.8944 20.5528C12.4555 20.7723 12.2361 20.882 12 20.882C11.7639 20.882 11.5445 20.7723 11.1056 20.5528L11.1056 20.5528L5.78886 17.8945C5.00832 17.5042 4.61804 17.3091 4.61804 17C4.61804 16.691 5.00832 16.4959 5.78886 16.1056L7.02157 15.4893Z" fill="white"/>
                            </svg>
                        </Stack>
                        <Text my='20px' fontSize={'28px'} fontWeight={'700'} color='#fff' letterSpacing={'0.1em'}>Support and Maintenance</Text>
                        <Text my='20px' fontSize={'16px'} fontWeight={'500'} color='rgba(255, 255, 255, 0.6)' letterSpacing={'0.1em'}>Not just build an app, but we also provide support and maintenance services with various support levels.</Text>
                    </Box>
                </SimpleGrid>
