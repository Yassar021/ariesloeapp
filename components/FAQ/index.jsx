import { Box, Flex, Text, Accordion, AccordionItem, AccordionButton,AccordionPanel, AccordionIcon, Container  } from "@chakra-ui/react"
            ...
            <Box pb='200px'>
                ...
                <Accordion bgColor='transparent' borderColor={'transparent'}>
                        <AccordionItem>
                            <h2>
                                <AccordionButton>
                                    <Box flex='1' textAlign='left' fontWeight='700' fontSize='20px' color='#fff'>
                                        How is the payment system?
                                    </Box>
                                    <AccordionIcon color='#fff' />
                                </AccordionButton>
                            </h2>
                            <AccordionPanel py={'10px'} fontSize='16px' color='rgba(255, 255, 255, 0.6)'>
