  ...
  return (
    <Box pb="100px">
      ...
      >
        <Box>
          ...
          <Text
            ...
            lineHeight="54px"
          >
            Solve your companys repetitive <br />
            problems by designing apps
          </Text>
        </Box>
      </Flex>
      ...
      <Center mt="124px">
        <VStack textAlign={"center"}>
          ...
          <Text
            ...
            letterSpacing={"0.1em"}
          >
            Here what you will get when purchasing this service
          </Text>
        </VStack>
      </Center>
      ...
      <Container maxW="5xl">
        <SimpleGrid
          mt="90px"
          columns={{ base: 1, md: 3, lg: 3, xl: 3, "2xl": 3 }}
          spacing="20px"
          textAlign="left"
        >
          <Box
            maxW="328px"
            h={{ md: "360px", lg: "315px", xl: "276px", "2xl": "276px" }}
            py="30px"
            px="46px"
          ...
          >
            <Stack>
              ...
              >
                <path
                  d="M10.4165 11.4584C10.4165 9.52454 11.1847 7.66988 12.5522 6.30243C13.9196 4.93497 15.7743 4.16675 17.7082 4.16675H24.9998V18.7501H17.7082C15.7743 18.7501 13.9196 17.9819 12.5522 16.6144C11.1847 15.2469 10.4165 13.3923 10.4165 11.4584Z"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M25 4.16675H32.2917C33.2492 4.16675 34.1974 4.35535 35.0821 4.72179C35.9667 5.08823 36.7706 5.62533 37.4477 6.30243C38.1248 6.97952 38.6618 7.78335 39.0283 8.66801C39.3947 9.55268 39.5833 10.5009 39.5833 11.4584C39.5833 12.416 39.3947 13.3641 39.0283 14.2488C38.6618 15.1335 38.1248 15.9373 37.4477 16.6144C36.7706 17.2915 35.9667 17.8286 35.0821 18.195C34.1974 18.5615 33.2492 18.7501 32.2917 18.7501H25V4.16675Z"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                />
                <path
                  d="M10.4165 26.0417C10.4165 24.1078 11.1847 22.2531 12.5522 20.8857C13.9196 19.5182 15.7743 18.75 17.7082 18.75H24.9998V33.3333H17.7082C15.7743 33.3333 13.9196 32.5651 12.5522 31.1977C11.1847 29.8302 10.4165 27.9755 10.4165 26.0417Z"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          >
            ...
            <Text
              ...
              color="rgba(255, 255, 255, 0.6)"
            >
              We dont want you to wait long. Everything will be finished on the
              same day..
            </Text>
          </Box>
          <Box
          ...
          >
            <Stack>
              ...
              >
                ...
                />
                <path
                  d="M16.27 19.96L25 25.01L33.73 19.96"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          >
            <Stack>
              ...
              >
                <path
                  d="M47.9168 12.5L28.1252 32.2917L17.7085 21.875L2.0835 37.5"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          >
            ...
            <Text
              ...
              color="rgba(255, 255, 255, 0.6)"
            >
              Access the website on any device, dont limit your visitors.
            </Text>
          </Box>
          <Box
            maxW="328px"
          ...
          >
            <Stack>
              ...
              >
                <path
                  d="M27.0833 4.16675L6.25 29.1667H25L22.9167 45.8334L43.75 20.8334H25L27.0833 4.16675Z"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        >
          ...
          <Box w="100%" h="auto">
            ...
            <Text
              ...
              lineHeight={"32px"}
            >
              You dont need to think about anything else, we have everything
          ...
          <Box w="100%" h="auto">
            ...
            >
              ...
              provided to you. You dont need to worry about this.
            </Text>
          </Box>
          <Box w="100%" h="auto">
            <Text fontSize={"20px"} fontWeight="700" color="#fff">
      ...
      <Center mt="90px">
        <Text fontSize={"16px"} fontWeight="700" color={"#fff"}>
          ...
          <Link href="/contact" color={"#6016FC"}>
            {" "}
