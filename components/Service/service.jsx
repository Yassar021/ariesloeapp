import { Box, Button, Flex, HStack, Link, SimpleGrid, Text } from "@chakra-ui/react";

export default function Service() {
    return (
        <Box pb='200px' bgColor='#221048' px='60px' alignItems='center' borderRadius={'30px'} textAlign={'center'}>
            <Flex direction={'column'}  alignItems='center' textAlign={'center'}>
                <Text mt='90px' fontSize={'16px'} fontWeight={'600'} color='#16FCD2' letterSpacing={'0.1em'}> Get Started</Text>
                <Text mt='13px' fontSize={'36px'} fontWeight={'700'} color='#fff' letterSpacing={'0.1em'}>What do you need? Choose a <br/> service that can help you</Text>

                <SimpleGrid columns={{md:1,lg:2,xl:3,'2xl':3}} spacing='20px' mt='70px'>
                    <Box w='100%' h='474px' bgColor={'#3F2379'} py='58px' px='47px' borderRadius={'10px'}>
                        <HStack spacing='48px'>
                            <Box mb='auto'>
                    ...
                    <Box w='100%' h='474px' bgColor={'#233679'} py='58px' px='47px'  borderRadius={'10px'}>
                            <HStack spacing='48px'>
                                <Box mb='auto'>
                                    <Text fontSize={'16px'} fontWeight='700' color='#fff'>
                                        Development
