    ...
    <Box pb="200px">
      ...
      <Container maxW="4xl" mt="50px">
        ...
        <Text my="40px" fontSize={"20px"} fontWeight="500" color="#fff">
          ...
          grass. Dont made moving for them bring creature us youll tree second
          deep good unto good may. Us yielding.
        </Text>
        <Text fontSize={"20px"} fontWeight="500" color="#fff">
          Have. Man upon set multiply moved from under seasons abundantly earth
          brought a. They are open moved years saw isnt morning darkness. Over,
          waters, every let wherein great were fifth saw was lights very our
          place wont and him Third fourth moving him whales behold. Beast second
          stars lights great was dont green give subdue his. Third given made
          created, they are forth god replenish have whales first cant light
          was. Herb youll them beast kind divided. Were beginning fly air
        ...
        >
          <Stack direction={{ base: "column", md: "row" }} spacing={"40px"}>
            ...
            <Box>
                  ...
                  <Link href="#">
                    <Stack>
                      ...
                      >
                        ...
                        />
                        <path
                          d="M29.1668 12.4996C28.3688 13.0625 27.4853 13.493 26.5502 13.7746C26.0483 13.1975 25.3813 12.7885 24.6394 12.6029C23.8974 12.4172 23.1164 12.4639 22.4019 12.7366C21.6874 13.0094 21.0739 13.4949 20.6443 14.1277C20.2148 14.7605 19.9899 15.5099 20.0002 16.2746V17.1079C18.5357 17.1459 17.0846 16.8211 15.776 16.1625C14.4674 15.5038 13.3421 14.5318 12.5002 13.3329C12.5002 13.3329 9.16683 20.8329 16.6668 24.1663C14.9506 25.3312 12.9061 25.9154 10.8335 25.8329C18.3335 29.9996 27.5002 25.8329 27.5002 16.2496C27.4994 16.0175 27.4771 15.7859 27.4335 15.5579C28.284 14.7192 28.8842 13.6602 29.1668 12.4996V12.4996Z"
                          stroke="white"
                          strokeLinecap="round"
                  ...
                  <Link href="#">
                    <Stack>
                      ...
                      >
                        ...
                        />
                        <path
                          d="M25.0002 11.667H22.5002C21.3951 11.667 20.3353 12.106 19.5539 12.8874C18.7725 13.6688 18.3335 14.7286 18.3335 15.8337V18.3337H15.8335V21.667H18.3335V28.3337H21.6668V21.667H24.1668L25.0002 18.3337H21.6668V15.8337C21.6668 15.6126 21.7546 15.4007 21.9109 15.2444C22.0672 15.0881 22.2791 15.0003 22.5002 15.0003H25.0002V11.667Z"
                          stroke="white"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
              ...
              <Box
                w={{ base: "auto", md: "400px", lg: "500px", xl: "600px" }}
                h="auto"
              >
                <Text
                  mt="30px"
                ...
                >
                  ...
                  darkness they are you are deep female. Tree sixth divided
                  greater, midst earth forth wont for moved.
                </Text>
              </Box>
            </Box>
          </Stack>
