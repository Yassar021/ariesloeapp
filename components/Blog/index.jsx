import { Box, Button, Center, Container, Flex, Link, SimpleGrid, Text } from "@chakra-ui/react"
    ...
    return ( 
        <Box pb='103px'>
            <Flex  mt='90px' direction={{base:'column',md:'row',lg:'row',xl:'row','2xl':'row'}} justifyContent='space-evenly' textAlign={{base:'center',md:'center',lg:'center',xl:'center','2xl':'center'}}>
                <Box>
                    <Text fontSize={'16px'} fontWeight={'600'} color='#16FCD2' letterSpacing={'0.1em'}>BLOG</Text>
                    <Text mt='13px' fontSize={'36px'} fontWeight='700' color='#fff' lineHeight='54px'>Get precise knowledge wherever you are</Text>
                </Box>
            </Flex>
            ...
            <Container maxW='8xl'>
                <SimpleGrid columns={{base:1,md:2,lg:3}} spacing={{base:'60px',md:'40px'}}>
