  ...
  return (
    <Box pb={"138px"}>
      ...
      >
        <Box
          w={{ base: "100%", md: "100%" }}
          h={{ base: "562px", md: "474px" }}
          bgColor={"rgba(255, 255, 255, 0.05)"}
          py={"58px"}
          px={{ base: "37px", md: "47px" }}
          borderRadius={"10px"}
        >
          <Stack
            direction={{
        ...
        <Box
          ml={{ base: "0px", md: "0px", lg: "192px", xl: "0px", "2xl": "0px" }}
          w={{ base: "100%", md: "100%" }}
          h={{ base: "562px", md: "474px" }}
          bgColor={"rgba(255, 255, 255, 0.05)"}
          py={"58px"}
      ...
      >
        ...
        <Box w="100%" h="auto">
          ...
          >
            ...
            problems and provide our best solutions. You can contact us via the
            contact page.
          </Text>
        </Box>
        <Box w="100%" h="auto">
          ...
          <Text
            ...
            lineHeight={"32px"}
          >
            We promise to always finish the project on time, if a problem occurs
            (because of our mistake), all payments will be refunded. And the
        ...
        <Box w="100%" h="auto">
          ...
          <Text
            ...
            lineHeight={"32px"}
          >
            When the project is 100% complete, all the resources, such as design
            files, analysis diagrams, source code, etc. will be provided to you.
